...
controlhandle([], [], [], 0);
odeT = T(1) :Td: T(2); 
solution1 = ode1(@(t, x)plant_lin(t, x, control_delay(t, controlhandle(mystep(t, T(1) + t_step, y0, y_step), output_delay(t, x), t)), X0, A, B, Bz), odeT, X0);
